            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-white text-dark" style="border-radius: 1rem;">
                    <div class="text-center" style="width:100%; height: 100px; background: #FF6F31;border-radius: 15px 15px 0px 0px;"><br>
                        <h5 style="font-size:50px;" class="text-light">Pastor Details</h5>
                    </div>
                    <div class="card-body p-5">
                        @foreach($pastors as $pastor)
                        <form action="updatePastor/{{$pastor->id}}" method="post">
                            ...
                            <div class="form-outline form-white mb-1">
                                <label for="name" class="form-label fs-5 text-start" style="color:#FF6F31;">Pastor Name</label>
                                <input type="text" name="name" value="{{ $pastor->name }}" class="form-control" style="background: #F2F2F2; border-radius: 10px;">
