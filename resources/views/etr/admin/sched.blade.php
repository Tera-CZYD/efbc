        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-white text-dark" style="border-radius: 1rem;">
                    ...
                    <h5 style="font-size:50px;" class="text-light">Schedule Details</h5>
                    </div>
                    <div class="card-body p-5">
                        @foreach($scheds as $sched)
                        <form action="updateSched/{{$sched->id}}" method="post">
                            ...
                            <div class="form-outline form-white mb-1">
                                <label for="name" class="form-label fs-5 text-start" style="color:#FF6F31;">Time</label>
                                <input type="text" name="time" value="{{ $sched->time }}" class="form-control" style="background: #F2F2F2; border-radius: 10px;">
                                <span class="text-danger">@error('time'){{ $message }} @enderror</span><br>
                            </div>
                            <div class="form-outline form-white mb-1">
                                <label for="name" class="form-label fs-5 text-start" style="color:#FF6F31;">Activity</label>
                                <input type="text" name="desc" value="{{ $sched->description }}" class="form-control" style="background: #F2F2F2; border-radius: 10px;">
                                <span class="text-danger">@error('desc'){{ $message }} @enderror</span><br>
                            </div>
